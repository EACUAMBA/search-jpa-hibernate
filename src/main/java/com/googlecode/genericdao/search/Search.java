...
public class Search implements IMutableSearch, Serializable {
    ...
    /**
     * Create a copy of this search. All collections are copied into new collections, but them items in those collections are not
     * duplicated; they still point to the same objects.
     */
    public Search copy() {
     ...
     * in {@link Filter#custom(String)}. Note that this method should be used with a custom filter, otherwise you have no access to the
     * joined element.
     * 
     * Here is an example to return all BlogPosts with a Technology keyword (tag):<br/>
     * 
     * <pre>
     * new Search(BlogPost.class).addJoin(&quot;inner join {keywordList} kw&quot;).addFilterCustom(&quot;kw.title = ?1&quot;, &quot;Technology&quot;);
     * </pre>
     * 
     * Above code would result into something like this JPQL:
     * 
     * <pre>
     * select bp from BlogPost bp inner join bp.keywordList kw where kw.title = 'Technology'
     * </pre>
     * 
     * @param join a JPA join (inner/outer) expression
     * @return this
     * @since 1.3.0
     */
    public Search addJoin(String join) {
        SearchUtil.addJoin(this, join);
        return this;
    }
